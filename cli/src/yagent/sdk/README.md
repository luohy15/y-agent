...
| `templates/starter.{tsx,json}` | Scaffold written by `y ui create`. The `.tsx` is the canonical example of the module shape: `export const panel` (required) and `export const detail` (optional). |
