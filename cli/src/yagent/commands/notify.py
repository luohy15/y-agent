...
@click.option('--trace-id', required=True, help='Trace ID for cross-skill communication')
@click.option('--new', 'new_chat', is_flag=True, help='Force create a new chat')
@click.option('--from-chat-id', default=None, help='Caller chat ID')
@click.option('--from-work-dir', default=None, help='Caller working directory')
@click.option('--from-skill', default=None, help='Caller skill name')
