...
export default function Header({ email, isLoggedIn, gsiReady, onLogout, onToggleSidebar, onToggleChatList, chatListOpen, onOpenFileSearch, onClickLogo, vmList, selectedVM, onSelectVM }: HeaderProps) {
